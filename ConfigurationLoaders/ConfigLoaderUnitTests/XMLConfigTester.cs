...
/// <summary>
/// Unit tests for the XML configuration loader.
/// </summary>
[TestClass]
public sealed class XMLConfigTester
{
    private const string ConfigFilePath = "../../../config.xml";
    private const string NonCompConfigFilePath = "../../../non_compatible_config.xml";
    private const string NonExistingConfigFilePath = "non_existing_config.xml";
    ...
    /// <summary>
    /// Tests loading a non-compatible XML file and expects a InvalidOperationException.
    /// </summary>
    [TestMethod]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestLoadNonCompatibleXmlFile()
    {
